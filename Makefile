...
all: rtl sim ffi # bitstream

rtl: $(BUILDDIR)/$(TOP).v
sim: sysDemoSim.out .demo_sim_ffi
ffi: .demo_ffi
...
BSC_SOURCES := SizedFIFO.v Counter.v MakeResetA.v SyncFIFO.v ClockDiv.v FIFO2.v SyncResetA.v FIFO1.v FIFO20.v
